...
-- also soared in popularity. Use subqueries to display the titles of movies starting with the 
...
-- all family movies for a promotion. Identify all movies categorized as _family_ films.
...
SELECT * FROM genre_revenue3;

-- 8c. You find that you no longer need the view `top_five_genres`. 
-- Write a query to delete it
DROP VIEW genre_revenue3;
